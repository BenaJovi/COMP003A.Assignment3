...
// Course: COMP - 003A
// Purpose: Will ouput letter grade based on numeric grade entered.
// Will also take a number value for the days of the week and output the corresponding weekday. 
// 
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            if (TotalGrade <= 100 && TotalGrade >= 0)
            {
                ...
                {
                    Console.WriteLine("Letter Grade: F. This means you failed.");                     // If this condition is met, the letter grade F will be displayed.
                }
